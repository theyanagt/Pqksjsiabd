...
let handler = async (m, { conn, usedPrefix: _p, __dirname, args }) => {
  ...
  let arrayMenu = ['all', 'anime', 'update', 'edukasi', 'news', 'random', 'game', 'xp', 'islamic', 'stiker', 'rpg', 'kerangajaib', 'quotes', 'admin', 'group', 'premium', 'internet', 'anonymous', 'nulis', 'downloader', 'tools', 'fun', 'jadian', 'database', 'quran', 'audio', 'audioanime', 'info', 'mods', 'owner']
 ...
 if (teks == 'nsfw') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	{title: `✨ ${pmenus} Rate`, rowId: ".ratebot", description: '╰► Support BOT agar Semangat update'},
	]
	},{
	...
	{title: `👩 ${pmenus} Moderator`, rowId: ".? mods", description: "Moderator Only"},
